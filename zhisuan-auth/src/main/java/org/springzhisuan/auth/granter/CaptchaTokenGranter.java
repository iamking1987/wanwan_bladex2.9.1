...
public class CaptchaTokenGranter extends AbstractTokenGranter {
	...
	private ZhisuanRedis zhisuanRedis;

	public CaptchaTokenGranter(AuthenticationManager authenticationManager,
							   AuthorizationServerTokenServices tokenServices, ClientDetailsService clientDetailsService, OAuth2RequestFactory requestFactory, ZhisuanRedis zhisuanRedis) {
	...
	protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
		...
		// 获取验证码
		String redisCode = zhisuanRedis.get(CacheNames.CAPTCHA_KEY + key);
		// 判断验证码
