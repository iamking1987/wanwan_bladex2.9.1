...
import org.springzhisuan.core.cloud.feign.ZhisuanFallbackFactory;
 ...
 * @author Chill
 */
public class ZhisuanFeignSentinel {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new ZhisuanSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default(fallbackInstance));
					}
					if (void.class != fallbackFactory) {
						...
						return new ZhisuanSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					// 默认fallbackFactory
					ZhisuanFallbackFactory zhisuanFallbackFactory = new ZhisuanFallbackFactory(target);
					return new ZhisuanSentinelInvocationHandler(target, dispatch, zhisuanFallbackFactory);
				}
